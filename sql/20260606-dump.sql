...
--
-- Host: localhost
-- Erstellungszeit: 06. Jun 2026 um 22:22
...
(9, 5, 186, 'Gween Fwog uwu', 7, 12, 0, 1172, 1200, 150, 680, 500, 0, 'f', 100, 90, 118, 1, '2025-11-15 22:34:57'),
...
(20, 5, 116, 'WillWee', 7, 1, 0, 0, 12, 6, 7, 5, 0, 'f', 100, 89, 6, 1, '2025-11-28 09:12:58'),
(21, 5, 59, 'Centaurea', 8, 1, 0, 0, 12, 6, 7, 5, 0, 'f', 100, 89, 4, 1, '2025-11-28 09:33:31'),
(22, 5, 181, 'Charra', 9, 1, 0, 0, 12, 6, 7, 5, 0, 'f', 100, 89, 6, 1, '2025-11-28 10:35:26'),
(23, 5, 178, 'Yellow-Onna', 8, 1, 0, 0, 12, 6, 7, 5, 0, 'f', 100, 90, 4, 1, '2025-11-28 10:36:05'),
(24, 16, 248, 'RedDeath', 1, 1, 0, 10, 10, 18, 11, 12, 0, 'f', 0, 50, 0, 0, '2025-12-16 08:16:01'),
(25, 5, 248, 'Widdly-Widdly-Wee', 7, 1, 0, 0, 10, 18, 11, 12, 0, 'f', 100, 99, 9, 1, '2025-12-18 13:05:25'),
(26, 5, 241, 'Lülüth', 6, 1, 0, 0, 18, 14, 10, 18, 0, 'f', 100, 99, 8, 1, '2025-12-18 16:45:04'),
(27, 5, 251, 'Furple', 8, 1, 0, 0, 8, 19, 4, 12, 0, 'f', 100, 99, 8, 0, '2025-12-23 08:49:12'),
...
(38, 5, 237, 'BfhTest', 2, 12, 0, 5, 21, 14, 14, 14, 0, 'f', 100, 99, 0, 1, '2026-04-22 12:31:48');
...
(13, 1, 127594.18, 20260604.00),
(12, 1, 2138.00, 20251116.00),
(14, 1, 2562.50, 20251120.00),
(5, 1, 65625194330.30, 20260606.00),
...
--
ALTER TABLE `currency_ledger`
  MODIFY `ledger_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=398;
...
--
ALTER TABLE `items`
  MODIFY `item_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=341;
...
--
ALTER TABLE `pet_instances`
  MODIFY `pet_instance_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
...
--
ALTER TABLE `player_unlocked_species`
  MODIFY `entryId` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=80;
