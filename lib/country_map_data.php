...
function get_country_map_config(string $slug): ?array {
    ...
    $configs = [
        'baharamandal' => [
            'title' => 'Baharamandal - Padmanagara', 'subtitle' => 'City of the Lotus', 'image' => 'images/harmontide-padmanagara.webp',
        ...
        'bretonreach' => [
            'title' => 'Bretonreach - Avalore', 'subtitle' => 'The Bastion of Stormwalls', 'image' => 'images/harmontide-br.webp',
        ...
        'cc' => ['title' => 'Crescent Caliphate - Ansurah', 'subtitle' => 'Moonlit Markets and Minarets', 'image' => 'images/harmontide-cc.webp', 'lore' => 'Ansurah is known for scholarship, caravans, and cosmopolitan bazaars under crescent towers.', 'areas' => [
        ...
        'esd' => ['title' => 'Eagle Serpent Dominion - Coatlxochi', 'subtitle' => 'Feathers, Stone, and Sun', 'image' => 'images/harmontide-esd.webp', 'lore' => 'Coatlxochi blends ceremonial plazas with martial tradition and serpent-eagle iconography.', 'areas' => [
        ...
        'esl' => ['title' => 'Eretz-Shalem League - Shalemdor', 'subtitle' => 'Covenants and Citadels', 'image' => 'images/harmontide-esl.webp', 'lore' => 'Shalemdor is a covenant city where law, trade, and pilgrimage routes converge.', 'areas' => [
        ...
        'gc' => ['title' => 'Gran Columbia - Solvine', 'subtitle' => 'City of Sun-Winds', 'image' => 'images/harmontide-gc.webp', 'lore' => 'Solvine is a bright trading city with strong civic plazas and highland-coast culture.', 'areas' => [
        ...
        'hammurabia' => ['title' => 'Hammurabia - Ziggurab', 'subtitle' => 'Steps of Bronze Law', 'image' => 'images/harmontide-hammurabia.webp', 'lore' => 'Ziggurab rises in terraced districts where scribes and merchants keep meticulous records.', 'areas' => [
        ...
        'ie' => ['title' => 'Itzam Empire - Itzankaan', 'subtitle' => 'Jade Courts and Canals', 'image' => 'images/harmontide-ie.webp', 'lore' => 'Itzankaan pairs imperial ceremony with vibrant waterway life and star-calendar observances.', 'areas' => [
        ...
        'kemet' => ['title' => 'Kemet - Ankhmeru', 'subtitle' => 'River Crown of Sand and Stone', 'image' => 'images/harmontide-k.webp', 'lore' => 'Ankhmeru is a Nile-like capital of monuments, scholars, and river-borne markets.', 'areas' => [
        ...
        'ldk' => ['title' => 'Lotus-Dragon Kingdom - Shenhedu', 'subtitle' => 'Silk, Steel, and Lanterns', 'image' => 'images/harmontide-ldk.webp', 'lore' => 'Shenhedu balances imperial ritual, artisan guilds, and riverfront commerce.', 'areas' => [
        ...
        'rsc' => ['title' => 'Red Sun Commonwealth - Redwind', 'subtitle' => 'Crimson Towers and Coin-Fairs', 'image' => 'images/harmontide-rsc.webp', 'lore' => 'Redwind is a proud commonwealth capital known for market games and showman culture.', 'areas' => [
        ...
        'rheinland' => ['title' => 'Rheinland - Rheingard', 'subtitle' => 'Iron Rivers, Ordered Streets', 'image' => 'images/harmontide-rheingard.webp', 'lore' => 'Rheingard is an industrial capital of strict timetables, workshops, and fortress bridges.', 'areas' => [
            ...
            ['name' => 'Frozen Frontline', 'description' => 'Visit the local special event sector.', 'action' => 'Enter', 'href' => '?pg=rl_ff', 'color' => '#38bdf8', 'points' => country_map_rect_points(710, 340, 250, 170, $w, $h)],
        ]],
        'rt' => ['title' => 'Rodinian Tsardom - Velesgrad', 'subtitle' => 'Frostdomes and Gilded Courts', 'image' => 'images/harmontide-rt.webp', 'lore' => 'Velesgrad is a tsardom capital of grand avenues, onion domes, and winter festivals.', 'areas' => [
        ...
        'sie' => ['title' => 'Sapa Inti Empire - Intirumi', 'subtitle' => 'The High Sun Seat', 'image' => 'images/harmontide-sie.webp', 'lore' => 'Intirumi perches in mountain terraces where ritual roads and market stairs intertwine.', 'areas' => [
        ...
        'sc' => ['title' => 'Sila Council - Qilaktuk', 'subtitle' => 'Aurora Council at the Ice Edge', 'image' => 'images/harmontide-sc.webp', 'lore' => 'Qilaktuk is a northern council-city shaped by sea ice, seasonal travel, and shared stewardship.', 'areas' => [
        ...
        'stap' => ['title' => 'Sovereign Tribes - Turtlestar', 'subtitle' => 'Circle Fires and Open Plains', 'image' => 'images/harmontide-stap.webp', 'lore' => 'Turtlestar is a plains capital organized around council circles, trade paths, and sky festivals.', 'areas' => [
        ...
        'srl' => ['title' => 'Spice Route League - Navakai', 'subtitle' => 'Harbor of Sails and Spice', 'image' => 'images/harmontide-srl.webp', 'lore' => 'Navakai thrives on sea trade, spice guilds, and vibrant dockside markets.', 'areas' => [
        ...
        'urb' => ['title' => 'United free Republic of Borealia - Meridian Arc', 'subtitle' => 'Free Ports and Arc-Lights', 'image' => 'images/harmontide-urb.webp', 'lore' => 'Meridian Arc is a republican metropolis balancing trade rights, free districts, and civic debate.', 'areas' => [
        ...
        'xochimex' => ['title' => 'Xochimex - Xochival', 'subtitle' => 'Festival Canals and Flowers', 'image' => 'images/harmontide-xochimex.webp', 'lore' => 'Xochival is a festival-rich city of flower markets, music, and floating neighborhoods.', 'areas' => [
        ...
        'yamanokubo' => ['title' => 'Yamanokubo - Amatera', 'subtitle' => 'Neon Lanes and Shrine Hills', 'image' => 'images/harmontide-yamanokubo.webp', 'lore' => 'Amatera blends old shrine hills with high-energy nightlife and story-rich backstreets.', 'areas' => [
        ...
        'yn' => ['title' => 'Yara Nations - Warraluma', 'subtitle' => 'Where River Meets Song', 'image' => 'images/harmontide-yn.webp', 'lore' => 'Warraluma stands between river and escarpment, with Country-led stewardship and gathering grounds.', 'areas' => [
