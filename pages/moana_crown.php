...
$moanaCrownMapAreas = [
    [
        'id' => 'srl',
        'name' => 'Spice Route League',
        'description' => 'Island harbors, reef roads, and ocean trade winds.',
        'action' => 'Explore',
        'href' => '?pg=srl',
        'color' => '#22d3ee',
        'coords' => '408,51,252,541,25,1303,449,2145,601,2280,802,2082,849,1724,807,1121,934,862,925,505,955,414,874,203,704,11',
    ],
];

$cityCards = [
    ['name' => 'Spice Route League', 'description' => 'Lots of islands and their fascinating culture.', 'href' => '?pg=srl'],
];
?>

<div class="country-map-page">
    <div class="country-map-header">
        <h1>Moana Crown Map</h1>
    ...
    <div class="country-map-wrap moana-map-wrap">
        <a class="country-map-back-link" href="?pg=map">← Back to world map</a>

        <div class="country-map-media" id="moanaMapMedia" style="aspect-ratio: 984 / 2299;">
            <img src="images/maps/harmontide-moanacrown.webp" alt="Moana Crown map" class="country-map-image" draggable="false">

            <svg viewBox="0 0 984 2299" preserveAspectRatio="none" class="country-map-overlay">
                <?php foreach ($moanaCrownMapAreas as $index => $area):
            ...
            <div class="country-map-tooltip" id="moanaMapTooltip"></div>

            <div class="country-map-panel" id="moanaMapPanel">
                <h3 id="moanaPanelTitle"></h3>
                <p id="moanaPanelDescription"></p>
                <a href="#" class="btn" id="moanaPanelLink"></a>
            </div>
        </div>
    </div>
...
.moana-map-wrap { max-width: 560px; margin: 0 auto; }
...
.moana-cards { margin-top: 1rem; }
</style>

<script>
(function () {
    const mapMedia = document.getElementById('moanaMapMedia');
    if (!mapMedia) return;

    const tooltip = document.getElementById('moanaMapTooltip');
    const panel = document.getElementById('moanaMapPanel');
    const panelTitle = document.getElementById('moanaPanelTitle');
    const panelDescription = document.getElementById('moanaPanelDescription');
    const panelLink = document.getElementById('moanaPanelLink');
