...
$dawnmarchMapAreas = [
    [
        'id' => 'baharamandal',
        'name' => 'Baharamandal',
        'description' => 'Temple roads, crowded markets, and ancient dynasties.',
        'action' => 'Explore',
        'href' => '?pg=baharamandal',
        'color' => '#f59e0b',
        'coords' => '678,9,344,15,122,257,70,570,99,948,134,961,237,800,313,781,400,486,451,334,703,211',
    ],
    [
        'id' => 'ldk',
        'name' => 'Lotus-Dragon Kingdom',
        'description' => 'Imperial cities, mountain monasteries, and dragon banners.',
        'action' => 'Explore',
        'href' => '?pg=ldk',
        'color' => '#22d3ee',
        'coords' => '802,61,721,159,696,230,470,335,393,581,333,782,245,813,145,965,7,1139,53,1233,217,1249,433,1239,504,1216,494,1146,513,1107,510,1075,525,1016,786,772,828,727,848,678,880,643,882,565,893,524,880,459,873,376',
    ],
    [
        'id' => 'yamanokubo',
        'name' => 'Yamanokubo',
        'description' => 'Coastal strongholds, misty forests, and disciplined clans.',
        'action' => 'Explore',
        'href' => '?pg=yamanokubo',
        'color' => '#a78bfa',
        'coords' => '943,21,809,58,882,383,898,515,890,637,858,692,809,766,539,1017,523,1081,523,1119,502,1152,512,1229,1626,1229,1616,1100',
    ],
];

$cityCards = [
    ['name' => 'Lotus-Dragon Kingdom', 'description' => 'Quit, don\'t quit. Noodles.', 'href' => '?pg=ldk'],
    ['name' => 'Baharamandal', 'description' => 'Yoga bros are gonna make you believe that this is not a shit sty', 'href' => '?pg=baharamandal'],
    ['name' => 'Yamanokubo', 'description' => 'The land of honor and responsibility.', 'href' => '?pg=yamanokubo'],
];
?>
...
<div class="country-map-page">
    ...
    <div class="country-map-wrap dawnmarch-map-wrap">
        <a class="country-map-back-link" href="?pg=map">← Back to world map</a>

        <div class="country-map-media" id="dawnmarchMapMedia" style="aspect-ratio: 1644 / 1272;">
            <img src="images/maps/harmontide-dawnmarch.webp" alt="Dawnmarch map" class="country-map-image" draggable="false">

            <svg viewBox="0 0 1644 1272" preserveAspectRatio="none" class="country-map-overlay">
                <?php foreach ($dawnmarchMapAreas as $index => $area):
            ...
            <div class="country-map-tooltip" id="dawnmarchMapTooltip"></div>

            <div class="country-map-panel" id="dawnmarchMapPanel">
                <h3 id="dawnmarchPanelTitle"></h3>
                <p id="dawnmarchPanelDescription"></p>
                <a href="#" class="btn" id="dawnmarchPanelLink"></a>
            </div>
        </div>
    </div>
...
.dawnmarch-map-wrap { max-width: 860px; margin: 0 auto; }
...
.dawnmarch-cards { margin-top: 1rem; }
</style>

<script>
(function () {
    const mapMedia = document.getElementById('dawnmarchMapMedia');
    if (!mapMedia) return;

    const tooltip = document.getElementById('dawnmarchMapTooltip');
    const panel = document.getElementById('dawnmarchMapPanel');
    const panelTitle = document.getElementById('dawnmarchPanelTitle');
    const panelDescription = document.getElementById('dawnmarchPanelDescription');
    const panelLink = document.getElementById('dawnmarchPanelLink');
