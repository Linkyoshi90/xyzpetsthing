...
$tundriaMapAreas = [
    [
        'id' => 'sc',
        'name' => 'Sila Council',
        'description' => 'Arctic coasts, permafrost towns, and icebound sea routes.',
        'action' => 'Explore',
        'href' => '?pg=sc',
        'color' => '#22d3ee',
        'coords' => '278,8,5,73,70,244,235,352,370,314,466,444,590,565,599,586,641,580,683,531,819,476,844,364,977,410,1039,383,1034,296,1008,168,1010,78,765,19,662,6',
    ],
];

$cityCards = [
    ['name' => 'Sila Council', 'description' => 'The only country on this continent.', 'href' => '?pg=sc'],
];
?>
...
<div class="country-map-page">
    ...
    <div class="country-map-wrap tundria-map-wrap">
        <a class="country-map-back-link" href="?pg=map">← Back to world map</a>

        <div class="country-map-media" id="tundriaMapMedia" style="aspect-ratio: 1042 / 593;">
            <img src="images/maps/harmontide-tundria.webp" alt="Tundria map" class="country-map-image" draggable="false">

            <svg viewBox="0 0 1042 593" preserveAspectRatio="none" class="country-map-overlay">
                <?php foreach ($tundriaMapAreas as $index => $area):
            ...
            <div class="country-map-tooltip" id="tundriaMapTooltip"></div>

            <div class="country-map-panel" id="tundriaMapPanel">
                <h3 id="tundriaPanelTitle"></h3>
                <p id="tundriaPanelDescription"></p>
                <a href="#" class="btn" id="tundriaPanelLink"></a>
            </div>
        </div>
    </div>
...
.tundria-map-wrap { max-width: 860px; margin: 0 auto; }
...
.tundria-cards { margin-top: 1rem; }
</style>

<script>
(function () {
    const mapMedia = document.getElementById('tundriaMapMedia');
    if (!mapMedia) return;

    const tooltip = document.getElementById('tundriaMapTooltip');
    const panel = document.getElementById('tundriaMapPanel');
    const panelTitle = document.getElementById('tundriaPanelTitle');
    const panelDescription = document.getElementById('tundriaPanelDescription');
    const panelLink = document.getElementById('tundriaPanelLink');
