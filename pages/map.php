...
$worldAreas = [
    [
        ...
        'color' => '#ffd166',
        'description' => 'A broad western land filled with bustling settlements and old roadways.',
    ],
    [
        'name' => 'Verdania',
        ...
        'color' => '#6ee7b7',
        'description' => 'Green lowlands and forested reaches tucked into the southwest.',
    ],
    [
        'name' => 'Dawnmarch',
        ...
        'color' => '#fca5a5',
        'description' => 'A frontier of cliffs and marches stretching across the south-central world.',
    ],
    [
        'name' => 'Gulfbelt',
        ...
        'color' => '#93c5fd',
        'description' => 'A coastal nexus of bays, trade routes, and connecting waters.',
    ],
    [
        'name' => 'Orienthem',
        ...
        'color' => '#c4b5fd',
        'description' => 'Mountain passes and storied cities shape this vibrant eastern region.',
    ],
    [
        'name' => 'Borealia',
        ...
        'color' => '#67e8f9',
        'description' => 'Far-northern reaches of frost and wind-carved terrain.',
    ],
    [
        'name' => 'Uluru',
        ...
        'color' => '#fdba74',
        'description' => 'Dry heartlands and red earth routes crossing the inner continent.',
    ],
    [
        'name' => 'Moana Crown',
        ...
        'color' => '#86efac',
        'description' => 'Island chains and ocean kingdoms circling the southeastern seas.',
    ],
    [
        'name' => 'Saharene',
        ...
        'color' => '#f9a8d4',
        'description' => 'Desert winds, ancient dunes, and caravan pathways define this realm.',
    ],
    [
        'name' => 'Tundria',
        ...
        'color' => '#e5e7eb',
        'description' => 'A glacial crown where snowfields and icebound peaks dominate.',
    ],
];
