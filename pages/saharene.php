...
$sahareneMapAreas = [
    [
        'id' => 'kemet',
        'name' => 'Kemet',
        'description' => 'River temples, desert roads, and ancient stone dynasties.',
        'action' => 'Explore',
        'href' => '?pg=kemet',
        'color' => '#f59e0b',
        'coords' => '589,15,169,274,18,544,70,697,149,734,168,822,96,1014,61,1253,225,1450,368,1451,517,1166,800,1211,923,1083,1005,785,1037,469,920,284',
    ],
];

$cityCards = [
    ['name' => 'Kemet', 'description' => 'Sand as far as the Scarab can see.', 'href' => '?pg=kemet'],
];
?>
...
<div class="country-map-page">
    ...
    <div class="country-map-wrap saharene-map-wrap">
        <a class="country-map-back-link" href="?pg=map">← Back to world map</a>

        <div class="country-map-media" id="sahareneMapMedia" style="aspect-ratio: 1096 / 1532;">
            <img src="images/maps/harmontide-saharene.webp" alt="Saharene map" class="country-map-image" draggable="false">

            <svg viewBox="0 0 1096 1532" preserveAspectRatio="none" class="country-map-overlay">
                <?php foreach ($sahareneMapAreas as $index => $area):
            ...
            <div class="country-map-tooltip" id="sahareneMapTooltip"></div>

            <div class="country-map-panel" id="sahareneMapPanel">
                <h3 id="saharenePanelTitle"></h3>
                <p id="saharenePanelDescription"></p>
                <a href="#" class="btn" id="saharenePanelLink"></a>
            </div>
        </div>
    </div>
...
.saharene-map-wrap { max-width: 760px; margin: 0 auto; }
...
.saharene-cards { margin-top: 1rem; }
</style>

<script>
(function () {
    const mapMedia = document.getElementById('sahareneMapMedia');
    if (!mapMedia) return;

    const tooltip = document.getElementById('sahareneMapTooltip');
    const panel = document.getElementById('sahareneMapPanel');
    const panelTitle = document.getElementById('saharenePanelTitle');
    const panelDescription = document.getElementById('saharenePanelDescription');
    const panelLink = document.getElementById('saharenePanelLink');
